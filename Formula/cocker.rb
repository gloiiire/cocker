...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v1.1.0.0"
    sha256 cellar: :any_skip_relocation, all:      "00fa73bedfb546d1c2f33928efbb2f495fa68f15b5f368f5222575cab909a30e"
  end
