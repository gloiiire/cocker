...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.25"
    sha256 cellar: :any_skip_relocation, all:      "475edfac2ca36df49ce256b17b746a89ced017e96fc00f2d090dbda8d4d15d88"
  end
