...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v1.2.0.1"
    sha256 cellar: :any_skip_relocation, all:      "11399357924393d52a1c24b36c84802ea15163be60993565b117881044330c26"
  end
