...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.22"
    sha256 cellar: :any_skip_relocation, all:      "9710ca5f7987c4a0421cdedd57c2b050b31bef6fb6a2c9939a98fd83ecdd843b"
  end
