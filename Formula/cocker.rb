...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v1.1.0.1"
    sha256 cellar: :any_skip_relocation, all:      "b6419a8360b682b11aa6aefe04da5c7e60799d3c0d8d67cffa7e77739f23e723"
  end
