...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.19"
    sha256 cellar: :any_skip_relocation, all:      "b90917143e8ec80a6012063284542de19d4082776bd7512eefa0dbd3b18b90fb"
  end
