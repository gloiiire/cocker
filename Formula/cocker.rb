...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.23"
    sha256 cellar: :any_skip_relocation, all:      "3cf2864be41a36514611310eda8f4741a9253811c0494243bc43cfa3a2bdf16b"
  end
