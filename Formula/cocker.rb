...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.3"
    sha256 cellar: :any_skip_relocation, all:      "e5cb97e3374581895520bb27976596955bdd7b221dc97c50653932cb1c5aaf95"
  end
