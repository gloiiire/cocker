...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.13"
    sha256 cellar: :any_skip_relocation, all:      "ee4cb891b7f65b9feaff181ed6f16a9d3ff5188b139ec9e77ec4767882d78e8b"
  end
