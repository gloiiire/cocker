...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.6"
    sha256 cellar: :any_skip_relocation, all:      "b86dfabb54662e8e89ea44f2f099f901874548c4322b8ffe173c2c19bbdb5bd2"
  end
