...
class Cocker < Formula
  ...
  bottle do
    root_url "https://github.com/gloiiire/cocker/releases/download/v0.7.13.12"
    sha256 cellar: :any_skip_relocation, all:      "ade11ff66406e6ba8ab13a03be555b32cae70811ef862913966070d105f2f6fe"
  end
